...
- Write for a teammate who stepped away and is catching up: complete sentences, no shorthand or codenames invented mid-task. In unattended channels (print mode, worker sessions), your text is the only output.
